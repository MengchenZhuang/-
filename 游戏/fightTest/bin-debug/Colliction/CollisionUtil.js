...
(function (touch) {
    ...
    var CollisionUtil = (function () {
        ...
        CollisionUtil.polygonCollidesWithCircle = function (polygon, circle) {
            ...
            var v1 = new touch.Vector(new Point(circle.x, circle.y));
            var v2 = new touch.Vector(new Point(closestPoint.x, closestPoint.y));
    ...
    __reflect(CollisionUtil.prototype, "touch.CollisionUtil");
})(touch || (touch = {}));
