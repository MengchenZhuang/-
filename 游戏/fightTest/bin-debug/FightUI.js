...
var FightUI = (function (_super) {
    ...
    FightUI.prototype.init = function () {
        for (var i = 0; i < this.num; i++) {
            ...
            var monster = new Monster(_data.x, _data.y, _data.speed, 5, 0xffff00);
    ...
    FightUI.prototype.movedrawLine = function (ndots) {
        ...
        for (var _i = 0, ndots_1 = ndots; _i < ndots_1.length; _i++) {
            ...
            for (var i = 0; i < ndots.length; i++) {
                ...
                var xc = dot.x - ndot.x;
                var yc = dot.y - ndot.y;
                var lineDis = (dot.radio + ndot.radio) * (dot.radio + ndot.radio);
                // 如果x轴距离或y轴距离大于max,则不计算粒子距离
                if (xc * xc > lineDis || yc * yc > lineDis)
                    continue;
                // 两个粒子之间的距离
                var dis = xc * xc + yc * yc;
                // 如果粒子距离超过max,则不做处理
    ...
    FightUI.prototype.moveCircle = function (dot) {
        //let self = this;
        // 粒子向英雄的位置移动
