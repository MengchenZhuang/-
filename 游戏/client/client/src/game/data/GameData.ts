...
module touch {
    ...
    export class GameData {
        ...
        /**武器组字典 */
        private static _weaponGroupDataMap: Laya.Dictionary = new Laya.Dictionary();
        /**武器数据 */
        private static _weaponDataArray: Array<WeaponData> = null;
        /**武器字典 */
        private static _weaponDataMap: Laya.Dictionary = new Laya.Dictionary();
        /**怪物数据 */
        private static _monsterDataArray: Array<MonsterData> = null
        /**怪物数据映射 */
        private static _monsterDataMap: Laya.Dictionary = new Laya.Dictionary()
