    ...
    export class Dictionary2 {
        ...
        public setItem(key: any, data: any): void {
            ...
            if (typeof key === "string" || typeof key === "number") {
                ...
                if (!key.hasOwnProperty(Dictionary2.HASCODE_NAME)) {
                    key[Dictionary2.HASCODE_NAME] = Dictionary2.hashCode;
                    Dictionary2.hashCode++;
                }
                this._objectMaps[key[Dictionary2.HASCODE_NAME]] = [key, data];
                this._count++;
        ...
        public delItem(key: any): void {
            ...
            if (typeof key === "string" || typeof key === "number") {
                ...
                if (key && key.hasOwnProperty(Dictionary2.HASCODE_NAME)) {
                    if (this._objectMaps[key[Dictionary2.HASCODE_NAME]]) {
                        delete this._objectMaps[key[Dictionary2.HASCODE_NAME]];
                        this._count--;
                    }
                }
        ...
        public getItem(key: any): any {
            if (typeof key === "string" || typeof key === "number") {
                ...
                if (key && key.hasOwnProperty(Dictionary2.HASCODE_NAME)) {
                    if (this._objectMaps[key[Dictionary2.HASCODE_NAME]])
                        return this._objectMaps[key[Dictionary2.HASCODE_NAME]][1];
                    else
                        return null;
                }
                else
        ...
        public hasOwnProperty(key: any): boolean {
            if (typeof key === "string" || typeof key === "number") {
                ...
                // }
                if (key.hasOwnProperty(Dictionary2.HASCODE_NAME)) {
                    return this._objectMaps[key[Dictionary2.HASCODE_NAME]] ? true : false;
                }
                else
                    return false;
            }
         ...
         * this.achieveDic.forEach(function (key: any, data: any): void {
				if(){
				}				
			},this);
         *
