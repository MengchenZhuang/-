...
module touch {
    ...
    export class Segment {
        public start: egret.Point = null
        public stop: egret.Point = null

        constructor(start: egret.Point, stop: egret.Point) {
            this.start = start
            this.stop = stop
        }
    ...
    export class Ray {
        public start: egret.Point = null
        public vector: egret.Point = null

        constructor(start: egret.Point, vector: egret.Point) {
            this.start = start
            this.vector = vector
        }
    ...
    export class LineIntersectionTool {
         ...
         * 射线和线段
         */
        public static ray2Segment(ray: Ray, segment: Segment): egret.Point {
         ...
         * 线段和线段
         */
        public static segment2Segment(s1: Segment, s2: Segment): egret.Point {
         ...
         * 直线和直线的交点
         */
        public static line2Line(line1: LineEquation, line2: LineEquation): egret.Point {
