...
module touch {
	...
	export class ShopBuyAmmoTimesCacheDic {
		/**已购买子弹次数字典*/
		private _shopBuyAmmoTimesDic:Dictionary;
		constructor(){
			this._shopBuyAmmoTimesDic = new Dictionary();
		}
	...
	export class ShopWeaponLevelUpTimesCacheDic {
		/**已升级次数字典*/
		private _shopWeaponLevelUpTimesDic:Dictionary;
		constructor(){
			this._shopWeaponLevelUpTimesDic = new Dictionary();
		}
