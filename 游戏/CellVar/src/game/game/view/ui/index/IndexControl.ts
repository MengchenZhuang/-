...
module touch {
	...
	export class IndexControl extends MVCControl {
		...
		public initialize(): void {
			...
			ui.btnStart.clickHandler = Handler.create(this, this.onStart, null, false);
			ui.btnTask.clickHandler = Handler.create(this, this.onTask, null, false);
			ui.btnShop.clickHandler = Handler.create(this, this.onShop, null, false);
			ui.btnSetting.clickHandler = Handler.create(this, this.onSetting, null, false);
			ui.btnSignIn.clickHandler = Handler.create(this, this.onSignIn, null, false);
		}
