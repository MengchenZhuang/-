...
module touch {
	 ...
	 * UI模块
	 */
	export class UIModule extends egret.EventDispatcher implements Module {
		/**
		 * UI中心
		 */
		...
		constructor() {
			super()
			//点击对话框遮罩区域不关闭界面
			//fairygui.UIConfig.closeDialogOnSide = false;
			fairygui.UIConfig.modalLayerAlpha = 0.8;
		...
		// public event<T extends UIable>(event,uiClass: { new (): T; }){
		// 	this.dispatchEventWith(event,false,uiClass);
